...
const BlockPuzzle = ({
  ...
  const paraDesktop = [
    "      Block Puzzle is a 2D, fun to play puzzle game, where",
    "\n       players place blocks of different shapes and sizes",
    "\n    on a grid and score points upon certain combinations.",
  ];

  const paraMobile = [
    "                                        Block Puzzle is a 2D, ",
    "\n                                     fun to play puzzle game,",
    "\n                                        where players place",
    "\n                                           block-patterns of",
    "\n                                        different shapes and",
    "\n                                    sizes on a grid and score",
    "\n                                          points upon certain",
    "\n                                             combinations.",
  ];
    ...
    <>
      <Canvas>
        ...
        >
          ...
          >
            {(isMobile && "Block Puzzle") ||
              (isTablet && "Block Puzzle") ||
              (isIpadPro && "Block Puzzle") ||
              "Block Puzzle"}
            <meshStandardMaterial
              color="#ff0000"
              emissive="#ff0000"
        ...
        >
          <Image
            url={"/bp1.png"}
            position={
              (isMobile && [-1.3, -2.6, 0.5]) ||
              (isTablet && [-1.9, -2.8, 0.5]) ||
              (isIpadPro && [-3.7, -1.6, 1.5]) || [-2.7, -2, 1.3]
            }
            scale={
              (isMobile && [3 / 2.7, 5.3 / 2.7]) ||
              (isTablet && [3 / 2, 5.3 / 2]) ||
              (isIpadPro && [3 / 1.7, 5.3 / 1.7]) || [3 / 1.7, 5.3 / 1.7]
            }
            toneMapped={false}
            radius={0.2}
          />
          ...
          <Image
            ...
            position={
              (isMobile && [0, -2.6, 0.5]) ||
              (isTablet && [0, -2.8, 0.5]) ||
              (isIpadPro && [0, -1.6, 1.5]) || [0.02, -2, 1.3]
            }
            scale={
              (isMobile && [3 / 2.7, 5.3 / 2.7]) ||
              (isTablet && [3 / 2, 5.3 / 2]) ||
