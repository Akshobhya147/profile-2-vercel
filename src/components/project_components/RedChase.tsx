...
const RedChase = ({ isMobile, isTablet, isIpadPro, backLink = "/" }: Media) => {
  const [hover, seHoverState] = useState(false);
  const navigate = useNavigate();
  const paraDesktop = [
    "Chase your opponents in this retro, arcade-style F-1 racing",
    "\n                                          game.",
  ];

  const paraMobile = [
    "                                       Chase your opponents ",
    "\n                                    in this retro, arcade-style",
    "\n                                            F-1 racing game.",
  ];
